...
public:
  ...
  uint64_t opcode() { return x(0, 7); } // decode opcode part of instruction
  uint64_t funct3() { return x(12, 3); } // decode funct3 part of instruction
  uint64_t funct7() { return x(25, 7); } // decode funct7 part of instruction
